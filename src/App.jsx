...
function App() {
  ...
  return (
    <div style={{ minHeight: '100vh' }} className='bg-dark d-flex justify-content-center align-items-center'>
      ...
      <div style={{ width: '400px' }} className='bg-light rounded p-4'>
        ...
        <form className="mt-4">
          ...
          <Stack direction="row" spacing={2}>
            <Button onClick={calculateInterest} disabled={invalidPriciple || invalidRate || invalidYear} style={{ width: '50%', height: '60px' }} className='bg-dark text-light' variant="contained">Calculate </Button>
